...
public struct DealRoot {
    public static func empty() -> DealRoot {
        return DealRoot(
            isEmpty: true,
            Id: "",
            deals: nil
...
extension DealRoot : Decodable {
    public static func decode(_ j:Any) throws -> DealRoot {
        return try DealRoot(
            isEmpty: false,
            Id: j => "_id",
            deals : j =>? "data"
